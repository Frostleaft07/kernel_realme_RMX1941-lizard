...
// KernelSU | You can get module umount feature working on pre-GKI kernels by manually backporting path_umount from 5.9. You can use this patch as reference:
